...
def read_data_from_url(url):
    try:
        ...
        unstr_loader = UnstructuredURLLoader(
            urls=[url], ssl_verify=False, remove_selectors=all_selectors
        )
        ...
        for page in pages:
            if page.page_content.strip() != "":
                ...
                cleaned_texts = [
                    text.strip() for text in cleaned_texts if text.strip() not in ["", None]
                ]
