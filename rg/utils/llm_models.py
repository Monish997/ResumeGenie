...
from rg.utils.utils import parse_json_markdown
from rg.variables import GEMINI_EMBEDDING_MODEL, GPT_EMBEDDING_MODEL, OLLAMA_EMBEDDING_MODEL
        ...
        try:
            ...
            def embed_fn(data):
                result = genai.embed_content(
                    ...
                    task_type=task_type,
                    title=(
                        "Embedding of json text"
                        if task_type in ["retrieval_document", "document"]
                        else None
                    ),
                )
